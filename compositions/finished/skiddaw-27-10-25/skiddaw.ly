...
verseOne = \lyricmode {
  \tiny
  May God His rich -- est bles -- sings give
  To you, my dear young friend;
  And make you use -- ful while you live,
...
verseTwo = \lyricmode {
  \tiny
  Your youth -- ful days will soon be gone,
  For time is fly -- ing by;
  Our days and years pass swift -- ly on,
