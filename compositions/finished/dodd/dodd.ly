...
poetName = "Social and Campmeeting Songs, 1828"
timeSignature = 6/4
...
verseOne = \lyricmode {
  ...
  I'll joy -- ful -- ly the call o -- bey,
  which comes to sum -- mon my a -- way
...
verseTwo = \lyricmode {
  ...
  There shall I see my Sav -- iour's face,
  And dwell in His be -- loved em -- brace,
  And taste the full -- ness of His grace,
