...
songTitle = "Badminton"
songMeter = "7s"
songComposer = "Ed Johnson-Williams, 17 August 2025"
...
verseOne = \lyricmode {
  \tiny
  % Verse 1 lyrics
  Ho -- ly Je -- sus, love -- ly Lamb,
  Thine and on -- ly thine I am;
  Take my bo -- dy, spi -- rit, soul,
  On -- ly thou pos -- sess the whole

}

verseTwo = \lyricmode {
  \tiny
  Thou my dear -- est ob -- ject be,
  Let me e -- ver cleave to thee;
  Let me choose the bet -- ter part,
